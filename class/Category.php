...
class Category extends DbObject {
 ...
 public static function fetch(){
    ...
    while($row=mysqli_fetch_assoc($query)){
            ...
            $sub_array[]='<a href="javascript:void(0);" data-id="'.$row['id'].'" class="text-info edit_btn_category">
        <i class="ti ti-edit"></i>
        </a> <a href="javascript:void(0);" data-id="'.$row['id'].'" class="text-danger delete_category">
